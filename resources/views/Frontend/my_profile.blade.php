                ...
                <div class="col-sm-12 col-md-3 col-lg-3">
                    ...
                    <div class="dashboard_tab_button" data-aos="fade-up" data-aos-delay="0">
                        <ul role="tablist" class="nav flex-column dashboard-list">
                            ...
                            <li> <a href="#orders" data-bs-toggle="tab" class="nav-link">Edit profile</a></li>
                            <li><a href="#downloads" data-bs-toggle="tab" class="nav-link">profile photo</a></li>
                            ...
                            <li>
                                ...
                                <a href="{{route('logout')}}" onclick="event.preventDefault();
                                   this.closest('form').submit();" class="nav-link">logout
                                </a>
                                </form>
                            </li>
                        </ul>
                ...
                <div class="col-sm-12 col-md-9 col-lg-9">
                    ...
                    <div class="tab-content dashboard_content" data-aos="fade-up" data-aos-delay="200">
                        <div class="tab-pane fade show active" id="dashboard">
                            ...
                            <p>From your account dashboard. you can easily View &amp;
                                <a href="#">, Edit </a>, manage your
                                <a href="#">profile and  Information's</a> also <a
                                    href="#">Edit your password and update your account details.</a></p>
